...
""", unsafe_allow_html=True)
        ...
        if not st.session_state['selected_project_details'].empty:
            ...
            st.dataframe(st.session_state['selected_project_details'].style.format({"Project ID": "{:.0f}", "epics_System_Id": "{:.0f}",'Total Effort Points': "{}"}), hide_index=True) 
        ...
        anchor_project_df['projects_Priority_Traffic_Ops'] = pd.to_numeric(anchor_project_df['projects_Priority_Traffic_Ops'], errors='coerce').fillna(0).astype(int)
        anchor_project_df['projects_Construction_EA_Number'] = pd.to_numeric(anchor_project_df['projects_Construction_EA_Number'], errors='coerce').fillna(0).astype(int)
        anchor_project_df['projects_Work_Item_ID'] = pd.to_numeric(anchor_project_df['projects_Work_Item_ID'], errors='coerce').fillna(0).astype(int)
        anchor_project_df['epics_System_Id'] = pd.to_numeric(anchor_project_df['epics_System_Id'], errors='coerce').fillna(0).astype(int)
        anchor_project_df['projects_Anchor_Project'] = pd.to_numeric(anchor_project_df['projects_Anchor_Project'], errors='coerce').fillna(0).astype(int)
        anchor_project_df['projects_Complexity_Signals'] = pd.to_numeric(anchor_project_df['projects_Complexity_Signals'], errors='coerce').fillna(0).astype(int)
        anchor_project_df['projects_Complexity_Lighting'] = pd.to_numeric(anchor_project_df['projects_Complexity_Lighting'], errors='coerce').fillna(0).astype(int)
        anchor_project_df['projects_Complexity_ITS'] = pd.to_numeric(anchor_project_df['projects_Complexity_ITS'], errors='coerce').fillna(0).astype(int)
        anchor_project_df['projects_Complexity_Power_Design'] = pd.to_numeric(anchor_project_df['projects_Complexity_Power_Design'], errors='coerce').fillna(0).astype(int)
        anchor_project_df['projects_Complexity_RoW_Coordination'] = pd.to_numeric(anchor_project_df['projects_Complexity_RoW_Coordination'], errors='coerce').fillna(0).astype(int)
        anchor_project_df['projects_Complexity_SLI_Project_Lead'] = pd.to_numeric(anchor_project_df['projects_Complexity_SLI_Project_Lead'], errors='coerce').fillna(0).astype(int)
        anchor_project_df['projects_Complexity_Solar_Design'] = pd.to_numeric(anchor_project_df['projects_Complexity_Solar_Design'], errors='coerce').fillna(0).astype(int)
        anchor_project_df['projects_Complexity_Trunkline'] = pd.to_numeric(anchor_project_df['projects_Complexity_Trunkline'], errors='coerce').fillna(0).astype(int)
        anchor_project_df['projects_complexity'] = pd.to_numeric(anchor_project_df['projects_complexity'], errors='coerce').fillna(0).astype(int)
        ...
        styled_anchor_df = anchor_project_df.style.format(format_dict)

        st.dataframe(styled_anchor_df, hide_index=True)
        st.write("Non Anchor")
        non_anchor_project_df['projects_Fiscal_Year'] = pd.to_numeric(non_anchor_project_df['projects_Fiscal_Year'], errors='coerce').fillna(0).astype(int)
        non_anchor_project_df['projects_Priority_Traffic_Ops'] = pd.to_numeric(non_anchor_project_df['projects_Priority_Traffic_Ops'], errors='coerce').fillna(0).astype(int)
        non_anchor_project_df['projects_Construction_EA_Number'] = pd.to_numeric(non_anchor_project_df['projects_Construction_EA_Number'], errors='coerce').fillna(0).astype(int)
        non_anchor_project_df['projects_Work_Item_ID'] = pd.to_numeric(non_anchor_project_df['projects_Work_Item_ID'], errors='coerce').fillna(0).fillna(0).astype(int)
        non_anchor_project_df['epics_System_Id'] = pd.to_numeric(non_anchor_project_df['epics_System_Id'], errors='coerce').fillna(0).fillna(0).astype(int)
        non_anchor_project_df['projects_Anchor_Project'] = pd.to_numeric(non_anchor_project_df['projects_Anchor_Project'], errors='coerce').fillna(0).astype(int)
        non_anchor_project_df['projects_Complexity_Signals'] = pd.to_numeric(non_anchor_project_df['projects_Complexity_Signals'], errors='coerce').fillna(0).astype(int)
        non_anchor_project_df['projects_Complexity_Lighting'] = pd.to_numeric(non_anchor_project_df['projects_Complexity_Lighting'], errors='coerce').fillna(0).astype(int)
        non_anchor_project_df['projects_Complexity_ITS'] = pd.to_numeric(non_anchor_project_df['projects_Complexity_ITS'], errors='coerce').fillna(0).astype(int)
        non_anchor_project_df['projects_Complexity_Power_Design'] = pd.to_numeric(non_anchor_project_df['projects_Complexity_Power_Design'], errors='coerce').fillna(0).astype(int)
        non_anchor_project_df['projects_Complexity_RoW_Coordination'] = pd.to_numeric(non_anchor_project_df['projects_Complexity_RoW_Coordination'], errors='coerce').fillna(0).astype(int)
        non_anchor_project_df['projects_Complexity_SLI_Project_Lead'] = pd.to_numeric(non_anchor_project_df['projects_Complexity_SLI_Project_Lead'], errors='coerce').fillna(0).astype(int)
        non_anchor_project_df['projects_Complexity_Solar_Design'] = pd.to_numeric(non_anchor_project_df['projects_Complexity_Solar_Design'], errors='coerce').fillna(0).astype(int)
        non_anchor_project_df['projects_Complexity_Trunkline'] = pd.to_numeric(non_anchor_project_df['projects_Complexity_Trunkline'], errors='coerce').fillna(0).astype(int)
        non_anchor_project_df['projects_complexity'] = pd.to_numeric(non_anchor_project_df['projects_complexity'], errors='coerce').fillna(0).astype(int)
